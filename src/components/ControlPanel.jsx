  ...
  return (
    <div className="control-panel">
      ...
      <div className="control-buttons">
        <button className="control-btn save-btn" onClick={onSave} title="Save diagram to browser">
          💾 Save
        </button>
        <button className="control-btn load-btn" onClick={onLoad} title="Load saved diagram">
          📂 Load
        </button>
        ...
        <button className="control-btn clear-btn" onClick={onClear} title="Clear canvas">
          🗑️ Clear
        </button>      </div>      <div className="help-text">
