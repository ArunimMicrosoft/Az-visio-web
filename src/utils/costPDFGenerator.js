...
export const generateCostPDF = (items, regionKey = 'eastus', currencyKey = 'USD') => {
  try {
    ...
    doc.setFontSize(10);
    doc.text("Arunim's IT Café — Cloud Canvas Designer v2.5.0", pageWidth / 2, 52, { align: 'center' });
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.setFontSize(7);
      doc.text(`© Arunim's IT Café | Cloud Canvas Designer v2.5.0 | ${reportDate}`, pageWidth / 2, pageHeight - 5, { align: 'center' });
    }
